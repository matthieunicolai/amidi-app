package com.amidi.myapp.config;
...
public class OpenApiConfiguration {
    ...
    public SpringfoxCustomizer noApiFirstCustomizer() {
        return docket -> docket.select().apis(RequestHandlerSelectors.basePackage("com.amidi.myapp.web.api").negate());
    }
    ...
    public Docket apiFirstDocket(JHipsterProperties jHipsterProperties) {
        ...
        return new Docket(DocumentationType.OAS_30)
            ...
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.amidi.myapp.web.api"))
