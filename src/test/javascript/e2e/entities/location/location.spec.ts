...
describe('Location e2e test', () => {
  ...
  it('should load Locations', async () => {
    ...
    expect(await locationComponentsPage.getTitle()).to.eq('amidiappApp.location.home.title');
  ...
  it('should load create Location page', async () => {
    ...
    expect(await locationUpdatePage.getPageTitle()).to.eq('amidiappApp.location.home.createOrEditLabel');
  ...
  it('should delete last Location', async () => {
    ...
    expect(await locationDeleteDialog.getDialogTitle()).to.eq('amidiappApp.location.delete.question');
