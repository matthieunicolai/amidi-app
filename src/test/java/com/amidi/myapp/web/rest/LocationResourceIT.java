...
import com.amidi.myapp.domain.Location;
import com.amidi.myapp.repository.LocationRepository;
import com.amidi.myapp.repository.search.LocationSearchRepository;
...
class LocationResourceIT {
     ...
     *
     * @see com.amidi.myapp.repository.search.LocationSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location().country(DEFAULT_COUNTRY).city(DEFAULT_CITY).postalCode(DEFAULT_POSTAL_CODE);
        return location;
    }
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location().country(UPDATED_COUNTRY).city(UPDATED_CITY).postalCode(UPDATED_POSTAL_CODE);
        return location;
    }
    ...
    void putNewLocation() throws Exception {
        ...
        updatedLocation.country(UPDATED_COUNTRY).city(UPDATED_CITY).postalCode(UPDATED_POSTAL_CODE);
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.country(UPDATED_COUNTRY).postalCode(UPDATED_POSTAL_CODE);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.country(UPDATED_COUNTRY).city(UPDATED_CITY).postalCode(UPDATED_POSTAL_CODE);
