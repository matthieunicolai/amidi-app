...
To build the final jar and optimize the amidiapp application for production, run:
...
Then navigate to [http://localhost:9330](http://localhost:9330) in your browser.
